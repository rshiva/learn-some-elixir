...
# IO.inspect PledgeServerHandRolled.create_pledge("Shiva", 20 )
# IO.inspect PledgeServerHandRolled.create_pledge("Larry", 10 )
# IO.inspect PledgeServerHandRolled.create_pledge("Sam", 50 )

# PledgeServerHandRolled.clear()
# IO.inspect PledgeServerHandRolled.create_pledge("Grace", 30 )
# IO.inspect PledgeServerHandRolled.create_pledge("curly", 20 )
